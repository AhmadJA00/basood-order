...
const helpers = {
  ...
  orderStatus: [
    ...
    {
      value: 10,
      label: "CancelledOfficeReceived",
      color: "#C82333",
    },
    {
      value: 11,
      label: "PartiallyCancelledOfficeReceived",
      color: "#E4606D",
    },
    {
      value: 12,
      label: "CancelledDriverReceived",
      color: "#B21F2D",
    },
    {
      value: 13,
      label: "PartiallyCancelledDriverReceived",
      color: "#E57373",
    },
    {
      value: 14,
    ...
    {
      value: 15,
      label: "PartiallyPaymentProcessing",
      color: "#9B59B6",
    },
    {
      value: 16,
      label: "CancelledSupplierReceived",
      color: "#E74C3C",
    },
    {
      value: 17,
